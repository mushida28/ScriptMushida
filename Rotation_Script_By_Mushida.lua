...
bots = {} --Don't change or delete this.
...
bots[getBots()[1].name] = {
	...
	Change_Bot_Status = "yes", --Options: yes or no.

	Bot_Format = "normal", --Options: normal or ubi.

--[[ Bot_List examp	

--Example Normal account: {"GROWID", "@PASSWORD", "MAC", "RID"},

--Example Guest account: {"GUEST1", "", "MAC_GUEST", "RID"},

--Example Ubisoft Connect account: {"GKSTEAM@gmail.com", "@PASSWORD"}, ]]

	Bot_List = {

	{"hwad2krg3d", "fbdlsn071@", "MAC", "RID"} --ADJUST TO THE USAGE EXAMPLE ABOVE.
    
	},

	

	Use_Max_Level_Status = "yes", --Options: yes or no.

	Max_Level = 20, --Fill in with number.

	

	Use_Rest_Bot = "yes", --Options: yes or no.

	Rest_Bot_Time = 30, --In minutes.

	

-----------------------------------------------------------

	Block_ID = 3472, --Fill in with item id.

	Custom_Break_Tile = "1", --Options: 1 tile to 5 tile.

	X_Break = 2, --Fill in the X break coordinate (View coordinate through the Growtopia app).

	Y_Break = 28, --Fill in the Y break coordinate (View coordinate through the Growtopia app).

	

	Rotation_World = {"umxij"},

	Rotation_Door_ID = "aditiya29",

	

	Save_Seed_World = "mhriceseed",

	Save_Seed_Door_ID = "yapmhd",

	

	Save_Pack_World = "mhdpack",

	Save_Pack_Door_ID = "yapmhd",



	Take_Pickaxe = "no", --Options: yes or no.

	Take_Pickaxe_World = "WORLD",

	Take_Pickaxe_Door_ID = "DOOR_ID",



-----------------------------------------------------------

	Buy_Rare_Clothes_Pack = "yes", --Options: yes or no.



-----------------------------------------------------------	

	Webhook_Link = "https://discord.com/api/webhooks/1174775847266304102/HVvA2Jc2VDw1qtjx7pNfDLVX980wcONxUxDfo-dMkrVGUBcV6Y_AiFaYRLhyuJB7v_yx",

	Use_Edit_Message_Webhook = "yes", --Options: yes or no.

	Webhook_Message_ID = "1174776066913603694", --If Use_Edit_Message_Webhook is yes, fill it with the bot message ID.



-----------------------------------------------------------

--You can change the pickaxe id with other hand items such as Pickaxe, Death Ray, and other hand items.
...
--Check out some of the Growtopia store debug here: https://discord.com/channels/1034711565565440034/1138761925031890975

	Pack_Name_To_Buy = "world_lock", --Fill in with Growtopia store debug.

	Pack_Price = 2000, --Fill in the package price.

	Max_Buy_Pack = 1, --Fill in with number.

	Max_Pack_To_Drop = 1, --Fill in with number.

	Custom_Drop_Pack = {242,}, --Fill in with item id.



-----------------------------------------------------------

--Use Sign/Display Box/other background items as position markers to drop.

	Drop_Seed_Marker = 4584, --Fill in with item id.

	Drop_Pack_Marker = 4584, --Fill in with item id.
...
--You can add multiple bots here by following the previous format!
...
--Set proxy/socks5.
	...
	Use_Proxy = "no" --Options: yes or yes.

	Proxy_File_Name = "proxyfile.txt" --Fill in the file name to save your proxy. Example: proxyfile.txt

	

--Proxy example: "012.345.678.90:12345:proxyUsername:proxyPassword",

	Add_Proxy = { 

	"012.345.678.90:12345:proxyUsername:proxyPassword",

	}

	

--Proxy_Limit example: fill with 3, meaning 3 bot/proxy.

	Proxy_Limit = 2 --Fill in with number.



---------------------------------------------------------------

	Max_Block_To_Retrieve = 150 --Fill in with number.

	Max_Seed_To_Plant = 1 --Fill in with number.

	

---------------------------------------------------------------

	Offline_After_Rotation_Completed = "yes" --Options: yes or no.

	

---------------------------------------------------------------

	Max_Reconnect = 30 --Number of repetitions of the connection call.

	Max_Reconnect_Delay = 5 --In minutes.

	

---------------------------------------------------------------

--[[ All trash items have been set automatically.

But you can also add any item you want to trash. 

Fill in with item id. ]]

	Trash_Item_ID = {5024, 5026, 5028, 5030, 5032, 5034, 5036, 5038, 5040, 5042, 5044, 5742, 5744, 5746, 5748, 7162, 7164, 9204}

	

---------------------------------------------------------------	

--[[ Exclude block, which will be destroyed. For example, 

Toxic Waste (usually this toxic waste likes to appear suddenly so if there is toxic waste, it will be destroyed). 
...
--[[ Jakarta/Indonesia's GMT time zone is +7 so you can write it as 7, 

the GMT time zone adjusts to your area, check Google for the GMT time zone in your area. 

Note: if your GMT time zone is minus, you can write it by adding a minus symbol like this -1. ]]

	GMT_Time_Zone = 7 --Fill in with number.
